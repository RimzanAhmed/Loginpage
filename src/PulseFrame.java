...
public class PulseFrame extends javax.swing.JFrame {
    ...
    private void bloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bloginActionPerformed
       if(juser.getText().equals("")){
           JOptionPane.showMessageDialog(null, "plese fill out");
       }
       else if(jpassword.getText().equals("")){
           JOptionPane.showMessageDialog(null, "plese fill out");
       }
       else if(juser.getText().contains("Rimzan")&& jpassword.getText().contains("Ashfa@01")){
            JOptionPane.showMessageDialog(null, "Login Success fulll");
       }
       else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PulseFrame().setVisible(true);
            }
        });
    }
